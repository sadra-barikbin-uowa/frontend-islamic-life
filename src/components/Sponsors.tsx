				...
				<div className="mt-12 grid items-start gap-8 sm:grid-cols-2 lg:gap-10">
					{sponsors.map((sponsor, i) => {
						const card = sponsor.logo ? (
							<div className="flex h-40 items-center justify-center rounded-xl border border-ink-900/10 bg-paper p-6 shadow-[0_8px_30px_rgba(15,27,61,0.06)] transition-all hover:-translate-y-1 hover:border-gold-400/50 dark:border-paper/10 dark:bg-ink-950 sm:p-8">
								<img
									src={sponsor.logo}
									alt={sponsor.name}
